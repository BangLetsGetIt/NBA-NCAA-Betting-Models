...
git add *.html *.json nba/*.html nba/*.csv ncaa/*.html ncaa/*.csv nfl/*.html nfl/*.json soccer/*.html soccer/*.json nba/*.json ncaa/*.json mlb/*.html mlb/*.json ufc/*.html ufc/data/*.json wnba/*.html wnba/*.json 2>/dev/null
