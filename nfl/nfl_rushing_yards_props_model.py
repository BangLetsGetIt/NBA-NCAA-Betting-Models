...
def get_nfl_player_rushing_yards_stats():
    """
    Fetch REAL NFL player rushing yards stats from cache (populated by fetch_nfl_player_stats.py)
    Returns dictionary with player rushing yards stats (season avg, recent form, etc.)
    """
    print(f"\n{Colors.CYAN}Loading NFL player rushing yards statistics...{Colors.END}")
