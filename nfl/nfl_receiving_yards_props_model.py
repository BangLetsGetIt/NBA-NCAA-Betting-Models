...
def get_nfl_player_receiving_yards_stats():
    """
    Fetch REAL NFL player receiving yards stats from cache (populated by fetch_nfl_player_stats.py)
    Returns dictionary with player receiving yards stats (season avg, recent form, etc.)
    """
    print(f"\n{Colors.CYAN}Loading NFL player receiving yards statistics...{Colors.END}")
