...
# Edge requirements - Strict for receiving yards
MIN_EDGE_OVER_LINE = 20.0  # Player must average 20+ above prop line for OVER
MIN_EDGE_UNDER_LINE = 15.0  # Player must average 15+ below prop line for UNDER
MIN_RECENT_FORM_EDGE = 12.0  # Recent form must strongly support
